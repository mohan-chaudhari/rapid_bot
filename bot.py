...
opt.add_argument("--always-authorize-plugins")
# opt.add_argument('user-data-dir=/home/ubuntu/.config/google-chrome/test_profile')
# opt.add_argument('--profile-directory=test_profile')

opt.add_argument("--remote-debugging-port=9222")
opt.add_argument("--remote-debugging-address=0.0.0.0")
opt.add_argument('--start-maximized')
opt.add_argument('--disable-dev-shm-usage')
opt.add_argument('window-size=2048x1536')
...
display = Display(visible=0, size=(2048, 1536))
display.start()
...
# go to google meet
driver.get('https://meet.google.com/edj-meeu-ceo')
