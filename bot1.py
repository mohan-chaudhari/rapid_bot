...
def joinNow():
	   # Wait for 2 seconds
    time.sleep(2)
    driver.find_element(By.XPATH, "/html/body/div/c-wiz/div/div/div[14]/div[3]/div/div[2]/div[4]/div/div/div[2]/div[1]/div[1]/div[3]/label/input").send_keys(any(mail_address))
    time.sleep(2)
